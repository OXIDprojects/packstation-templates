      ...
      <div class="box info">
          ...
          [{if $oView->showShipAddress()}]
            ...
            <table class="form" width="90%">
              ...
              <tr><td>[{ oxmultilang ident="USER_PACKSTATIONADDRESS" }]</td>
		      ...
		      <td>
                  <input id="packstr" type="text" size="28" maxlength="255" name="deladr[oxaddress__oxstreet]" value="[{if $delivadr->oxaddress__oxstreet->value}][{$delivadr->oxaddress__oxstreet->value}][{else}][{$deladr.oxaddress__oxstreet}][{/if}]">
