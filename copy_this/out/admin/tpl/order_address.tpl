...
<tr>
    ...
    <td valign="top" class="edittext" align="left" width="50%">
        ...
        <tr>
            <td class="edittext">
             [{if $edit->oxorder__oxdelstreet->value == 'Packstation'}][{ oxmultilang ident="GENERAL_PACKNR" }] [{else}][{ oxmultilang ident="GENERAL_STREETNUM" }][{/if}]
            </td>
            <td class="edittext">
        ...
        <tr>
            <td class="edittext">
            [{if $edit->oxorder__oxdelstreet->value == 'Packstation'}][{ oxmultilang ident="GENERAL_POSTNR" }][{else}][{ oxmultilang ident="GENERAL_EXTRAINFO" }][{/if}]
            </td>
            <td class="edittext">
